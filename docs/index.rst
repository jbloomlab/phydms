...
`phydms`_ can use :ref:`ExpCM` to describe the evolution of protein-coding genes for phylogenetic analyses and the detection of sites of biologically interesting selection.
