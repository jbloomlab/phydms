...
If you need to change the site numbers from the sequential numbering in the ``phydms`` output, use :ref:`phydms_renumber_prog` to renumber this output before passing it to ``phydms_selection``.
