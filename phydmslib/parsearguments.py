...
def PhyDMSParser():
    ...
    parser.add_argument('--diffprefalpha', default=1, help="Concentration parameter for '--diffprefsbysite'; larger values favor smaller diff prefs.", type=FloatGreaterThanZero)
    parser.add_argument('--diffprefsteps', default=1e4, type=int, help='MCMC steps for each chain for --diffprefsbysite')
