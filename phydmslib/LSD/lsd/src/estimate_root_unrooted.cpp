...
double estimate_root_without_constraint_unrooted(int n,int m,int* & Pur,double* & Bur,double* &V,double* & Tur,int &r,double &lambda,double &rho,double rho_min){
    //Pur: unrooted tree
    ...
    phi1=without_constraint_lambda(n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,rhor,rho_min,ld);
    //printf("%.10f\n",phi1);
    lambda=ld;
    rho=rhor;
    r=y;
    ...
    while (y<=m){
        ...
        computeSuc(P_new,Suc1_new,Suc2_new,m+2,n+1);
        //cout<<"Optimizing the root position on the branch "<<y<<" ... ";
        phi=without_constraint_lambda(n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,rhor,rho_min,ld);
        //printf("%.10f\n",phi);
        if (phi1>phi){
            phi1=phi;
            rho = rhor;
...
double estimate_root_without_constraint_rate_unrooted(double rho,int n,int m,int* & Pur,double* & Bur,double* &V,double* & Tur,int &r,double &lambda){
    //Pur: unrooted tree
    cout<<"Estimating the root without constraints ... ";
    double phi1=-1;
    int *P_new= new int[m+2];
    ...
    double ld;
    //cout<<"Optimizing the root position on the branch "<<y<<" ... ";
    phi1=without_constraint_lambda_rate(rho,n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,ld);
    //printf("%.10f\n",phi1);
    lambda=ld;
    r=y;
    y++;
    ...
    while (y<=m){
        ...
        computeSuc(P_new,Suc1_new,Suc2_new,m+2,n+1);
        //cout<<"Optimizing the root position on the branch "<<y<<" ... ";
        phi=without_constraint_lambda_rate(rho,n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,ld);
        //printf("%.10f\n",phi);
        if (phi1>phi){
            phi1=phi;
            r=y;
...
double estimate_root_with_constraint_rate_unrooted(double rho,int n,int m,int* & Pur,double* & Bur,double* &V,double* & Tur,int &r,double &lambda){
    //Pur: unrooted tree
    ...
    double ld;
    //cout<<"Optimizing the root position on the branch "<<y<<" ... ";
    phi1=with_constraint_active_set_lambda_rate(rho,n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,ld);
    //printf("%.10f\n",phi1);
    lambda=ld;
    r=y;
    y++;
    ...
    while (y<=m){
        ...
        computeSuc(P_new,Suc1_new,Suc2_new,m+2,n+1);
        //cout<<"Optimizing the root position on the branch "<<y<<" ... ";
        phi=with_constraint_active_set_lambda_rate(rho,n+1,m+1,br,P_new,Suc1_new,Suc2_new,B_new,V,T_new,ld);
        //printf("%.10f\n",phi);
        if (phi1>phi){
            phi1=phi;
            r=y;
